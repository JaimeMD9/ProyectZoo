...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(glm::mat4(1.0f), glm::vec3(-40.3f, -211.75f, 0.3f)); // translate it down so it's at the center of the scene
		...
		model = glm::translate(tmp, glm::vec3(160.5f, 2.5f, 12.9f));
		...
		model = glm::translate(tmp, glm::vec3(250.0f, 2.5f, 140.0f));
		...
		model = glm::translate(tmp, glm::vec3(110.0f, 2.5f, 260.0f));
		model = glm::scale(model, glm::vec3(4.0f, 4.0f, 4.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		...
		model = glm::translate(tmp, glm::vec3(190.0f, 2.5f, -20.0f));
		model = glm::scale(model, glm::vec3(4.0f, 4.0f, 4.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		...
		model = glm::translate(tmp, glm::vec3(360.0f, 2.5f, 20.0f));
		...
		model = glm::translate(tmp, glm::vec3(375.0f, 2.5f, -170.0f));
		model = glm::scale(model, glm::vec3(4.0f, 4.0f, 4.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		...
		model = glm::translate(tmp, glm::vec3(190.0f, 2.5f, -180.0f));
		model = glm::scale(model, glm::vec3(4.0f, 4.0f, 4.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		...
		//Zona Tigres
		model = glm::translate(tmp, glm::vec3(420.0f, 2.5f, 240.0f));
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		...
		model = glm::translate(tmp, glm::vec3(-350.0f, 2.5f, -100.0f));
		...
		model = glm::translate(tmp, glm::vec3(-200.0f, 2.5f, 200.0f));
		model = glm::scale(model, glm::vec3(0.35f, 0.35f, 0.35f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		staticShader.setMat4("model", model);
		Estacionamiento.Draw(staticShader);

		//ANIMACIONES PROYECTO TERMINADAS
